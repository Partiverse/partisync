# Task: partisync-cli clippy 债清偿（M4-OPEN-001）
...
- 提交挂 Task-ID `M4-OPEN-001`

## 后续可立同类任务

- `M4-OPEN-002`：WP06 渗透 3 项 P1 加固（asset_organize 批大小 / 跨库校验 / c2pa absent 形态）
- `M4-OPEN-003`：cli sidecar-run 深度上限
- `M4-OPEN-004`：MCP 调用审计日志